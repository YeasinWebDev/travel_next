...
import LeafletMap from "@/src/components/MapComponent";
import ReactLeafletMap from "@/src/components/MapComponent";

// Demo data for Rangamati Hill District
const demoDestination = {
  _id: "65f7c8a3d4e8a1b2c9e8f127",
  name: "Rangamati Hill District",
  location: "Chittagong Hill Tracts",
  description:
    "Beautiful lake district surrounded by hills, home to indigenous communities. Rangamati is a district in south-eastern Bangladesh, part of the Chittagong Hill Tracts. The town is located on the western bank of Kaptai Lake. Rangamati is the only region in Bangladesh where indigenous people are still the majority.",
  image: [
    "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0e/16/5e/59/rangamati-hanging-bridge.jpg?w=1400&h=1400&s=1",
    "https://bangladeshexplore.com/wp-content/uploads/2025/10/rangamati-hill-tracts.webp",
    "https://images.unsplash.com/photo-1593693399740-5a85c1c5c8f2?w=800&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1585506936724-fa0c19c2a94c?w-800&auto=format&fit=crop",
  ],
  interests: ["hills", "lake", "tribal culture", "boating", "photography", "adventure"],
  division: "692c571d3fb8a1e1418c8103",
  price: 2500,
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        {/* Back Button */}
        <button onClick={() => window.history.back()} className="mb-6 flex items-center text-blue-600 hover:text-blue-800 transition-colors cursor-pointer">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                  ...
                  <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors mb-4">Create A Tour</button>
                  <button className="w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-50 font-semibold py-3 px-4 rounded-lg transition-colors">Add to Wishlist</button>
                </div>
